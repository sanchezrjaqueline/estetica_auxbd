...
CREATE TABLE `citas` (
  ...
  `FECHA` date NOT NULL,
  `ID_SEVICIOS` int NOT NULL,
  `HORA_INICIO` time NOT NULL,
  `DURACION` time NOT NULL,
  PRIMARY KEY (`ID_CITA`),
  KEY `ID_EMPLEADO_idx` (`ID_TIENDA`,`ID_CLIENTE`)
...
INSERT INTO `cliente` VALUES (1,'JAQUELINE','SANCHEZ',431329);
...
-- Dump completed on 2020-07-06 19:21:30
